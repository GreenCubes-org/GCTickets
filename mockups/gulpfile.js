...
gulp.task('default', function() {
  gulp.start('include', 'libstyles', 'styles', 'scripts', 'watch');
});

// Запуск живой сборки
gulp.task('live', function() {
  gulp.start('server', 'include', 'libstyles', 'styles', 'scripts', 'watch');
});

// Туннель
gulp.task('external-world', function() {
  gulp.start('web-server', 'include', 'libstyles', 'styles', 'scripts', 'watch');
});
...
// Компиляция библиотечных стилей
gulp.task('libstyles', function () {
  return gulp.src(paths.styles + 'libs.css')
  .pipe(cssnext())
