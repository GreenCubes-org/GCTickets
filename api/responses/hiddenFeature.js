...
module.exports = function forbidden(data, options) {
	...
	if (data !== undefined) {
		sails.log.verbose('Sending 403-hf ("Forbidden: Hidden Feature") response: \n', data);
	} else sails.log.verbose('Sending 403-hf ("Forbidden: Hidden Feature") response');
	...
	else return res.view('errors/403-hf', {
		data: data,
